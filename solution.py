...
class SOLUTION:
  ...
  def Create_World(self):
    ...
    pyrosim.Send_Cube(name="FirstStep", pos=[-52.5,2,0.25], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="SecondStep", pos=[-53,2,0.75], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="ThirdStep", pos=[-53.5,2,1.25], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="FourthStep", pos=[-54,2,1.75], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="FifthStep", pos=[-54.5,2,2.25], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="SixthStep", pos=[-55,2,2.75], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="SeventhStep", pos=[-55.5,2,3.25], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="EighthStep", pos=[-56,2,3.75], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="NinthStep", pos=[-56.5,2,4.25], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="TenthStep", pos=[-57,2,4.75], size=[100,100,0.5],mass=1000.0)
    pyrosim.Send_Cube(name="EleventhStep", pos=[-57.5,2,5.25], size=[100,100,0.5],mass=1000.0)
    pyrosim.End()
  ...
  def Create_Brain(self):
    ...
    pyrosim.Send_Sensor_Neuron(name = 4 , linkName = "MiddleFrontLowerLeg")
    pyrosim.Send_Sensor_Neuron(name = 5 , linkName = "MiddleBackLowerLeg")
    pyrosim.Send_Sensor_Neuron(name = 6 , linkName = "MiddleLeftLowerLeg")
    pyrosim.Send_Sensor_Neuron(name = 7 , linkName = "MiddleRightLowerLeg")
    ...
    pyrosim.Send_Motor_Neuron( name = 16 , jointName = "Torso_MiddleBackLeg")
    pyrosim.Send_Motor_Neuron( name = 17 , jointName = "Torso_MiddleFrontLeg")
    pyrosim.Send_Motor_Neuron( name = 18 , jointName = "Torso_MiddleLeftLeg")
    pyrosim.Send_Motor_Neuron( name = 19 , jointName = "Torso_MiddleRightLeg")
    pyrosim.Send_Motor_Neuron( name = 20 , jointName = "MiddleFrontLeg_MiddleFrontLowerLeg")
    pyrosim.Send_Motor_Neuron( name = 21 , jointName = "MiddleBackLeg_MiddleBackLowerLeg")
    pyrosim.Send_Motor_Neuron( name = 22 , jointName = "MiddleLeftLeg_MiddleLeftLowerLeg")
    pyrosim.Send_Motor_Neuron( name = 23 , jointName = "MiddleRightLeg_MiddleRightLowerLeg")
