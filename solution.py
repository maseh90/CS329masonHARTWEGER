...
class SOLUTION:
  ...
  def Create_World(self):
    ...
    pyrosim.Send_Cube(name="SecondStep", pos=[-53.5,2,0.25], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="ThirdStep", pos=[-54.5,2,0.375], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="FourthStep", pos=[-55.5,2,0.5], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="FifthStep", pos=[-56.5,2,0.625], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="SixthStep", pos=[-57.5,2,0.75], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="SeventhStep", pos=[-58.5,2,0.875], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="EighthStep", pos=[-59.5,2,1], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="NinthStep", pos=[-60.5,2,1.125], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="TenthStep", pos=[-61.5,2,1.25], size=[100,100,0.25],mass=1000.0)
    pyrosim.Send_Cube(name="EleventhStep", pos=[-62.5,2,1.375], size=[100,100,0.25],mass=1000.0)
    pyrosim.End()
