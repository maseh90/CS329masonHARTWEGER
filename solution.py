...
class SOLUTION:
  ...
  def Create_World(self):
    ...
    pyrosim.Send_Cube(name="FirstStep", pos=[-52.5,2,0.25], size=[100,100,0.5])
    pyrosim.Send_Cube(name="SecondStep", pos=[-53,2,0.75], size=[100,100,0.5])
    pyrosim.Send_Cube(name="ThirdStep", pos=[-53.5,2,1.25], size=[100,100,0.5])
    pyrosim.Send_Cube(name="FourthStep", pos=[-54,2,1.75], size=[100,100,0.5])
    pyrosim.Send_Cube(name="FifthStep", pos=[-54.5,2,2.25], size=[100,100,0.5])
    pyrosim.Send_Cube(name="SixthStep", pos=[-55,2,2.75], size=[100,100,0.5])
    pyrosim.Send_Cube(name="SeventhStep", pos=[-55.5,2,3.25], size=[100,100,0.5])
    pyrosim.Send_Cube(name="EighthStep", pos=[-56,2,3.75], size=[100,100,0.5])
    pyrosim.Send_Cube(name="NinthStep", pos=[-56.5,2,4.25], size=[100,100,0.5])
    pyrosim.Send_Cube(name="TenthStep", pos=[-57,2,4.75], size=[100,100,0.5])
    pyrosim.Send_Cube(name="EleventhStep", pos=[-57.5,2,5.25], size=[100,100,0.5])
    pyrosim.End()
